...
static ::_pb::Metadata file_level_metadata_all_5fexample_2eproto[9];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_all_5fexample_2eproto = nullptr;
...
const char descriptor_table_protodef_all_5fexample_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021all_example.proto\"\036\n\006AddReq\022\t\n\001a\030\002 \001(\005"
  "\022\t\n\001b\030\003 \001(\005\"\030\n\006AddRsp\022\016\n\006result\030\002 \001(\005\"\026\n"
  "\007EchoReq\022\013\n\003str\030\002 \001(\t\"\026\n\007EchoRsp\022\013\n\003str\030"
  "\002 \001(\t\"%\n\007address\022\014\n\004addr\030\001 \001(\t\022\014\n\004port\030\002"
  " \001(\005\"*\n\020ServiceRegistReq\022\026\n\004addr\030\001 \001(\0132\010"
  ".address\"/\n\020ServiceRegistRsp\022\016\n\006status\030\001"
  " \001(\005\022\013\n\003msg\030\002 \001(\t\"\023\n\021GetServiceListReq\"0"
  "\n\021GetServiceListRsp\022\033\n\tserv_list\030\001 \003(\0132\010"
  ".addressB\003\200\001\001"
  ;
static ::_pbi::once_flag descriptor_table_all_5fexample_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_all_5fexample_2eproto = {
    false, false, 333, descriptor_table_protodef_all_5fexample_2eproto,
    "all_example.proto",
    &descriptor_table_all_5fexample_2eproto_once, nullptr, 0, 9,
    schemas, file_default_instances, TableStruct_all_5fexample_2eproto::offsets,
    file_level_metadata_all_5fexample_2eproto, file_level_enum_descriptors_all_5fexample_2eproto,
    file_level_service_descriptors_all_5fexample_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_all_5fexample_2eproto_getter() {
  return &descriptor_table_all_5fexample_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_all_5fexample_2eproto(&descriptor_table_all_5fexample_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata AddReq::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata AddRsp::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata EchoReq::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata EchoRsp::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[3]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata address::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[4]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ServiceRegistReq::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[5]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ServiceRegistRsp::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[6]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata GetServiceListReq::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[7]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata GetServiceListRsp::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_all_5fexample_2eproto_getter, &descriptor_table_all_5fexample_2eproto_once,
      file_level_metadata_all_5fexample_2eproto[8]);
}
