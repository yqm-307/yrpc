...
#include "yrpc/msg/servicemap.h"
#include "yrpc/protocol/Codec.h"
#include "Define.h"
 ...
 * @param function<ProtoMsgPtr(const ProtoMsgPtr,rpc::detail::SessionPtr)> func 服务处理函数,当连接建立并接收到protomsg时,将解析服务名并调用该服务; google::protobuf::Message*(ArgsPtr&)为服务原型函数,该服务需要
