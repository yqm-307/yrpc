...
#ifndef GOOGLE_PROTOBUF_INCLUDED_AddAndStr_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_AddAndStr_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_AddAndStr_2eproto
...
struct TableStruct_AddAndStr_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AddAndStr_2eproto;
class AddReq;
...
class AddReq final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_AddAndStr_2eproto;
};
// -------------------------------------------------------------------
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_AddAndStr_2eproto
